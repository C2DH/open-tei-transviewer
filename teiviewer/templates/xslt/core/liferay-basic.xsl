...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" exclude-result-prefixes="#all" version="2.0">
	<xd:doc scope="stylesheet">
		<xd:desc>
			...
			<xd:p>Creating a basic structure for Liferay integration.</xd:p>
		</xd:desc>
	</xd:doc>
    ...
    <xsl:template match="//tei:facsimile//tei:graphic" priority="1">
    	<img width="{./@width}" height="{./@height}" data-src="{./@url}" />
	</xsl:template>	

	<xsl:template match="//tei:text">
		<section xmlns="http://www.w3.org/1999/xhtml"  class="doc-part-text {$textType} {$textSubType}" id="{$textID}">
