...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <!-- Added by FAR -->
    <xsl:template name="specificCSS">
        <link xmlns="http://www.w3.org/1999/xhtml" id="specificCSS_dipl" href="{$pathCSSSpecific}/transcript-specific_dipl.css" rel="stylesheet" type="text/css" title="diplomativ"> </link>
    ...
    <xsl:template name="specificJS">
       <!--<script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript" src="{$pathSpecificJS}/ExploreText.js"></script>-->
